    ...
    <>
      ...
      <div className={styles.abas}>
        <div className="flex-column">
          ...
          <Link to="/funcionario/reservas" className={styles.link}>
            <AddressBook
              color={styleIcones("/funcionario/reservas").color}
              size={32}
              weight={
                styleIcones("/funcionario").weight as IconWeight | undefined
              }
            />
            <span className={styles.span}>Reservas</span>
          </Link>
          <Link to="/funcionario/ocupacoes" className={styles.link}>
            <DoorOpen
              ...
              size={32}
              weight={
                styleIcones("/funcionario/ocupacoes").weight as
                  | IconWeight
                  | undefined
              }
            />
